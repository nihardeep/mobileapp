# Old block that I deleted in the PREVIOUS step:
# I had:
html = """<div class="bluchip-bottom-layout" style="display: block; padding-top: 12px;">
...
print(f"Old block had {open_count} open, {close_count} close. Balance = {open_count - close_count}")
