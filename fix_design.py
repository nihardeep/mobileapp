...
start_str = '<div class="bluchip-bottom-layout" style="display: block; padding-top: 12px;">'
...
if start_idx != -1 and end_idx != -1:
    replacement = """<div class="bluchip-bottom-layout" style="display: block; padding-top: 8px;">
