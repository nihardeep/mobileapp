...
function renderFlightStateCard(state) {
    ...
    if (state === 'upcoming_trip') {
        ...
        html = `
            <div style="background: #fff8f1; border-radius: 16px; padding: 16px; margin-top: -10px; margin-bottom: 24px;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    ...
                    <div style="margin-right: 8px; position: relative; width: 48px; height: 48px;">
                        <!-- Fast Speed lines -->
        ...
        html = `
            ...
            <div style="font-size: 12px; font-weight: 800; color: #ef4444; margin-bottom: 12px; margin-top: 24px; display: flex; align-items: center; gap: 6px;">
...
function updateTimelineState(state) {
    ...
    if (['upcoming_trip', 'connection_risk', 'missed_flight'].includes(state)) {
...
// ==========================================================================
// DRAGGABLE DEV CONSOLE LOGIC
// ==========================================================================
document.addEventListener('DOMContentLoaded', () => {
    const devConsole = document.querySelector('.dev-simulator-console');
    const header = document.querySelector('.dev-console-title');
    if (!devConsole || !header) return;

    // Set initial styles for floating
    devConsole.style.position = 'fixed';
    devConsole.style.left = '20px';
    devConsole.style.top = '20px';
    devConsole.style.zIndex = '10000';
    devConsole.style.margin = '0'; // Remove any flex gaps
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        devConsole.style.left = \`\${initialLeft + dx}px\`;
        devConsole.style.top = \`\${initialTop + dy}px\`;
    });
